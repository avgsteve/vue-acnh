...
var validate_request_1 = require("./../middlewares/validate-request"); // https://express-validator.github.io/docs/sanitization.html
...
[express_validator_1.body('email').isEmail().withMessage('Email must be valid'), express_validator_1.body('password').trim().isLength({
  min: 4,
  max: 20
}).withMessage('Password must be between 4 and 20 characters')], validate_request_1.validateRequest, // middleware #2 檢查req.body的註冊內容
function (req, res) {
