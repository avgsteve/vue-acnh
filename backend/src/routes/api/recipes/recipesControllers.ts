...
export async function cachedBasicQueryData(req: Request, res: Response, next: NextFunction) {
  ...
  redisClient.get("recipes" + queryString, (err, data) => {
...
export async function basicQuery(req: Request, res: Response) {
  ...
  redisClient.setex("recipes" + queryString, 3600, JSON.stringify(doc))
...
export async function getAllCategories(req: Request, res: Response) {
  console.log('aggregation: getAllCategories for recipes:');
  ...
  redisClient.setex("sortedRecipeCategories", 3600, JSON.stringify(sortedRecipeCategories));
...
export async function cachedAllCategories(req: Request, res: Response, next: NextFunction) {
  ...
  redisClient.get("sortedRecipeCategories", (err, data) => {
