            ...
            switch (_a.label) {
                case 0:
                    if (!req.params.userId)
                        return [2 /*return*/, send400ResWithError('Please use user id for this api', res)];
                    userId = req.params.userId;
                    if (!mongoose_1["default"].isValidObjectId(userId))
                        return [2 /*return*/, send400ResWithError('user id is not valid MongoDB _id format', res)];
                ...
                case 1:
                    user = _a.sent();
                    if (!user)
                        return [2 /*return*/, send400ResWithError('User not found', res)];
                    res.send(user);
                    return [2 /*return*/];
            }
        });
