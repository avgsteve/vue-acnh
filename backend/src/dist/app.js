...
var compressionFilter_1 = require("./middlewares/compressionFilter");
...
app.use(compression_1["default"]({ filter: compressionFilter_1["default"] }), body_parser_1.json(), // parse req.body
cors_1["default"](), morgan_1["default"]('combined'), 
// cookieSession({
//   signed: false,
//   secure: false,
...
var userRoutes_1 = require("./routes/api/user/userRoutes");
var itemsRoutes_1 = require("./routes/api/items/itemsRoutes");
